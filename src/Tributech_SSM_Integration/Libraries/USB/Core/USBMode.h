...
#define __USBMODE_H__
	...
	/* Public Interface - May be used in end-application: */
		...
		/* Macros: */
				...
				#define USB_SERIES_C4_XMEGA
				#define USB_CAN_BE_DEVICE
      #elif (defined (XMC4800_E196x2048) || defined (XMC4800_F144x2048) || defined (XMC4800_F100x2048) || \
			...
			defined (XMC4700_E196x2048) || defined (XMC4700_F144x2048) || defined (XMC4700_F100x2048) || \
			defined (XMC4700_E196x1536) || defined (XMC4700_F144x1536) || defined (XMC4700_F100x1536) || \
			defined (XMC4500_E144x1024) || defined (XMC4500_F144x1024) || defined (XMC4500_F100x1024) || \
			defined (XMC4500_F144x768) || defined (XMC4500_F100x768) || defined (XMC4502_F100x768) || \
			defined (XMC4504_F100x512) || defined (XMC4504_F144x512) || defined (XMC4400_F100x512) || \
			defined (XMC4400_F64x512) || defined (XMC4400_F100x256) || defined (XMC4400_F64x256) || \
			defined (XMC4402_F100x256) || defined (XMC4402_F64x256) || defined (XMC4300_F100x256))
//        #define USB_CAN_BE_DEVICE
        #define USB_CAN_BE_HOST
			#endif
